...
victory_button = button.Button(330, 80, victory_img, 1 )
...
while not start_game:
    draw_menu_bg()
    draw_text("Welcome to Forest Invaders!", arial, (255, 255, 0), 40, 50)
    draw_text("Created by Yorick-Ntwari Niyonkuru", arial, (255, 255, 0), 40, 100)
    draw_text("You must save the magic forest from the ", arial, (255, 255, 0), 40, 150)
    draw_text("invasion of snakes!", arial, (255, 255, 0), 40, 200)
    draw_text("W: Jump, D: Move Right, S: Crouch, A: Move Left", arial, (255, 255, 0), 40, 250)
    draw_text("SPACEBAR: Attack", arial, (255, 255, 0), 40, 300)
    # detect mouse clicks
...
while not quit:
    ...
    if seconds_left == 1:
        draw_text(str(seconds_left) + " second left", pygame.font.Font("Pokemon GB.ttf", 32), (255, 200, 0), 10, 45)
    else:
        draw_text("Time Remaining:", pygame.font.Font("Pokemon GB.ttf", 20), (255, 200, 0), 10, 75)
        draw_text(str(seconds_left) + " seconds ", pygame.font.Font("Pokemon GB.ttf", 20), (255, 200, 0), 10, 100)
